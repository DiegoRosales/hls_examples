...
set_directive_array_partition -dim 1 -type complete "fft_wrapper" fft_obj.twiddle_factor_idx
set_directive_array_partition -dim 1 -type complete "fft_wrapper" fft_obj.idx_0
set_directive_array_partition -dim 1 -type complete "fft_wrapper" fft_obj.idx_1
