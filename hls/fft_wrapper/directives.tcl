...
set_directive_interface -mode s_axilite -bundle axi4l_if -clock clk "fft_wrapper"
...
set_directive_array_partition -type complete -dim 1 "fft_wrapper" fft_obj.twiddle_factors
